                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-evenly gap-10 mt-5">
                            <div className='flex flex-col items-center gap-y-4'>
                                <a href={singleProject.clintSite} target="blank" className=" hover:cursor-pointer hover:text-orange-400 duration-300 text-3xl" title='Clint Site Code'><FaGithubAlt /></a>
                                <p>Clint Site Code</p>
                            </div>
                            <div className='flex flex-col items-center gap-y-4'>
                                <a href={singleProject.serverSite} target="blank" className=" hover:text-orange-400 duration-300 text-3xl" title='Server Site Code'><FaGithubSquare /></a>
                                <p>Server Site Code</p>
                            </div>
                            <div className='flex flex-col items-center gap-y-4'>
                                <a href={singleProject.url} target="blank" className=" hover:text-orange-400 duration-300 text-3xl" title='Live Site'><FaRegPaperPlane /></a>
                                <p>Live Site Link</p>
                            </div>
                        </div>
                    </div>
